            ...
            <div className="card-body p-5 sm:p-6">
              ...
              >
                <label className="form-control w-full">
                  ...
                  <input
                    type="text"
                    className="input input-bordered w-full rounded-2xl border-[#E8DFC8] bg-white text-black placeholder:text-[#A39A7E] focus:border-[#3A3226] focus:outline-none focus:ring-2 focus:ring-[#3A3226]/20"
                    value={name}
